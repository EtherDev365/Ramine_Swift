...
class HDZoomTransitioner : NSObject, UIViewControllerTransitioningDelegate {
    ...
    func presentationController(forPresented presented: UIViewController, presenting: UIViewController?, source: UIViewController) -> UIPresentationController? {
        weak var ws = self
        let controller = HDSwipBackPresentationController.init(presentedViewController: presented, presenting: presenting) { (containerView) in
