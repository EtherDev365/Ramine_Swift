//
//  HDZoomAnimatedTransitioning.swift
//  DnDStudio
//
...
class HDZoomAnimatedTransitioning: NSObject, UIViewControllerAnimatedTransitioning {
...
//            var safeFrame = frame
//            safeFrame.height = safeFrame.height + toVC.additionalSafeAreaInsets.top + toVC.additionalSafeAreaInsets.bottom
        ...
        //toFrame
            //CGRect(x: toFrame.origin.x, y: toFrame.origin.y, width: toFrame.width, height: toFrame.height + toVC.additionalSafeAreaInsets.top + toVC.additionalSafeAreaInsets.bottom)
            //CGRect(x: toFrame.origin.x, y: toFrame.origin.y, width: toFrame.width, height: toFrame.height)
            ...
            UIView.animateKeyframes(withDuration: self.transitionDuration(using: transitionContext),
                                    ...
                                    animations: {
                                        ...
                                        UIView.addKeyframe(withRelativeStartTime: 0, relativeDuration: 1, animations: {
                                            var tframe = containerView.bounds
                                            let padding : CGFloat = appdelegate.window?.safeAreaInsets.top ?? 0
                                            
                                            if UIDevice().userInterfaceIdiom == .phone {
                                                print(UIScreen.main.nativeBounds.height , "nativeBounds.height----------------")
                                                
//                                                if appdelegate.window?.safeAreaInsets.top == 20 {
//                                                    padding = 20
//                                                }
                                                
                                                /*
                                                switch UIScreen.main.nativeBounds.height {
                                                case 2436, 2688, 1792 , 1334 , 2436 :
                                                    padding -= 0
                                                default:
                                                    print("Unknown")
                                                }*/
                                            ...
                                            tframe = CGRect(x: tframe.origin.x, y: tframe.origin.y+padding, width: tframe.width, height: tframe.height)
        ...
        else
        {
            ...
            shadow.backgroundColor = UIColor.clear;//nlhdung
...
//supper func
extension HDZoomAnimatedTransitioning {
